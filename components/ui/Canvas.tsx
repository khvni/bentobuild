        ...
        {blocks.length === 0 ? (
          <div className="text-center py-32" role="status" aria-live="polite">
            ...
            <div className="relative inline-block">
              ...
              <div className="absolute -top-8 -left-8 w-16 h-16 bg-bauhaus-red rounded-bauhaus-sm opacity-20" aria-hidden="true"></div>
              <div className="absolute -bottom-6 -right-6 w-12 h-12 bg-bauhaus-yellow rounded-full opacity-20" aria-hidden="true"></div>
              <div className="absolute top-1/2 -left-12 w-0 h-0 border-l-[20px] border-l-transparent border-r-[20px] border-r-transparent border-b-[35px] border-b-bauhaus-blue opacity-20" aria-hidden="true"></div>
              ...
              <div className="bg-white p-12 rounded-bauhaus-lg shadow-bauhaus-lg border-4 border-black relative z-10">
                ...
                <p className="text-sm text-gray-600 font-semibold uppercase tracking-wide">Drag blocks to start building</p>

                {/* Decorative accent line */}
                <div className="absolute bottom-0 left-0 w-full h-2 bg-gradient-to-r from-bauhaus-red via-bauhaus-yellow to-bauhaus-blue" aria-hidden="true"></div>
              </div>
            </div>
          </div>
        ) : (
